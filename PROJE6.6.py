...
class HumanPlayer(Player):
    def make_move(self):
        move = input("Karpuz, Elma, veya Muz seçin: ").lower()
        while move not in ['karpuz', 'elma', 'muz']:
            move = input("Geçersiz seçim! Karpuz, Elma, veya Muz seçin: ").lower()
        return move

class RandomComputerPlayer(ComputerPlayer):
    def make_move(self):
        return random.choice(['karpuz', 'elma', 'muz'])
...
class Game:
    ...
    def get_winner(self, human_move, computer_move):
        ...
        elif (human_move == 'karpuz' and computer_move == 'muz') or \
             (human_move == 'elma' and computer_move == 'karpuz') or \
             (human_move == 'muz' and computer_move == 'elma'):
